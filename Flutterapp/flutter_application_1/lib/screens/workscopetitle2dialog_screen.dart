...
class Workscopetitle2dialogScreen extends StatefulWidget {
  const Workscopetitle2dialogScreen({super.key});
  @override
  State<Workscopetitle2dialogScreen> createState() =>
      _Workscopetitle2dialogScreenState();
}

class _Workscopetitle2dialogScreenState
    extends State<Workscopetitle2dialogScreen> {
                      ...
                      Row(
                        children: [
                          ...
                          Transform.scale(
                            scale: 1.2,
                            child: Image.asset(
                              "assets/images/forwardarrow_dart.png",
                              color: Colors.black,
                            ),
                          ),
                        ],
                ...
                TextButton(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      width: double.infinity,
                      color: HexColor(
                          "A8A8A8"), // Yellow color for Corrective Action
                      child: Text(
                        "Cancel",
                        style: GoogleFonts.inter(
                          fontSize: 16,
